...
public class PaymentAddActivity extends AppCompatActivity {
    ...
    static final int ADD_PAYMENT_REQUEST_IMAGE_CAPTURE = 1;
    static final int CHECK_PASSWORD_REQUEST = 2;
    public final static String ADD_PAYMENT_EXTRA_MESSAGE_POSITION = "PaymentAddActivity.POSITION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(PaymentAddActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                final EditText title = (EditText) findViewById(R.id.add_payment_title);
                final String titleStr = title.getText().toString();
                final int pageNumber = PaymentPageData.getMaxPaymentPageNumber() + 1;
                    ...
                    DBBackgroudTask task = new DBBackgroudTask() {
                        ...
                        protected Object doInBackground(Object[] params) {
                            ...
                            for (GlobalDataStructure.OneDisplayRow row : mData) {
                                ...
                                values.put(RecordContract.RecordEntry.COLUMN_NAME_CATEGORY,GlobalDataStructure.TAB_PAYMENT);
                        ...
                        protected void onPostExecute(Object o) {
                            ...
                            // Read out the last added page from database, keep mPaymentPageData.mPagelist consistent with database
                            ...
                            if(cursor.moveToFirst()) {
                                ...
                                mPaymentPageData.mPagelist.add(onePage);

                                PaymentPageData.increasePaymentTabNumber();
                                PaymentPageData.setMaxPaymentPageNumber(pageNumber);
                                ...
                                PaymentTabFragment.topTabIndicator.setCurrentItem(PaymentPageData.getPaymentTabNumber()-1);
                            }
                            dbRead.close();
                        }
                    };
    ...
    private List<GlobalDataStructure.OneDisplayRow> addDefaultRow() {
        ...
        GlobalDataStructure.OneDisplayRow rowPayment = new GlobalDataStructure.OneDisplayRow();
        rowPayment.rowName = "Issue Bank";
        rowPayment.text = GlobalDataStructure.emptyString;
        rowPayment.image = null;
        rowPayment.rowType = GlobalDataStructure.ROW_USER_NAME;
        list.add(rowPayment);

        GlobalDataStructure.OneDisplayRow rowPassword = new GlobalDataStructure.OneDisplayRow();
        rowPassword.rowName = "Password";
        ...
        GlobalDataStructure.OneDisplayRow rowValid = new GlobalDataStructure.OneDisplayRow();
        rowValid.rowName = "Valid Date";
        rowValid.text = GlobalDataStructure.emptyString;
        rowValid.image = null;
        rowValid.rowType = GlobalDataStructure.ROW_DATE;
        list.add(rowValid);

        GlobalDataStructure.OneDisplayRow rowTelephone = new GlobalDataStructure.OneDisplayRow();
        rowTelephone.rowName = "Tel.";
        rowTelephone.text = GlobalDataStructure.emptyString;
        rowTelephone.image = null;
        rowTelephone.rowType = GlobalDataStructure.ROW_PHONE;
        list.add(rowTelephone);
        ...
        GlobalDataStructure.OneDisplayRow rowPicture = new GlobalDataStructure.OneDisplayRow();
        rowPicture.rowName = "Card Picture";
        rowPicture.text = GlobalDataStructure.emptyString;
        rowPicture.image = null;
        rowPicture.rowType = GlobalDataStructure.ROW_IMAGE;
        list.add(rowPicture);
    ...
    private void dispatchTakePictureIntent(int position) {
        ...
        takePictureIntent.putExtra(ADD_PAYMENT_EXTRA_MESSAGE_POSITION, position);
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (mData.get(position).imageFile != null) {
                ...
                startActivityForResult(takePictureIntent, ADD_PAYMENT_REQUEST_IMAGE_CAPTURE);
            }
        }
    }
    ...
    private File createImageFile(int position) throws IOException {
        ...
        String imageFileName = "AddPayment_" + position + "_";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if ((requestCode == ADD_PAYMENT_REQUEST_IMAGE_CAPTURE) && (resultCode == RESULT_OK)) {
            int position = takePictureIntent.getIntExtra(ADD_PAYMENT_EXTRA_MESSAGE_POSITION, 0);
