...
public class IDsAddActivity extends AppCompatActivity {
    ...
    static final int ADD_IDS_REQUEST_IMAGE_CAPTURE = 1;
    static final int CHECK_PASSWORD_REQUEST = 2;
    public final static String ADD_IDS_EXTRA_MESSAGE_POSITION = "IDsAddActivity.POSITION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ids_add);
        ListView listView = (ListView) findViewById(R.id.add_ids_listview);

        // Get the message from the startIntent
        startIntent = getIntent();
        int tab = startIntent.getIntExtra(MainActivity.EXTRA_MESSAGE_MAIN, -1);
        if (tab == GlobalDataStructure.TAB_IDS) {
            mData = addDefaultRow();
        }
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(IDsAddActivity.this, R.style.My_Theme_AlertDialog));
                AlertDialog.Builder builder = new AlertDialog.Builder(IDsAddActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                final EditText title = (EditText) findViewById(R.id.add_ids_title);
                final String titleStr = title.getText().toString();
                final int pageNumber = IDsPageData.getMaxIDsPageNumber() + 1;
                    ...
                    DBBackgroudTask task = new DBBackgroudTask() {
                        ...
                        protected Object doInBackground(Object[] params) {
                            ...
                            for (GlobalDataStructure.OneDisplayRow row : mData) {
                                ...
                                values.put(RecordContract.RecordEntry.COLUMN_NAME_CATEGORY,GlobalDataStructure.TAB_IDS);
                        ...
                        protected void onPostExecute(Object o) {
                            ...
                            // Read out the last added page from database, keep mIDsPageData.mPagelist consistent with database
                            ...
                            if(cursor.moveToFirst()) {
                                ...
                                mIDsPageData.mPagelist.add(onePage);

                                IDsPageData.increaseIDsTabNumber();
                                IDsPageData.setMaxIDsPageNumber(pageNumber);
                                ...
                                IDsTabFragment.topTabIndicator.setCurrentItem(IDsPageData.getIDsTabNumber()-1);
                            }
                            dbRead.close();
                        }
                    };
    ...
    private List<GlobalDataStructure.OneDisplayRow> addDefaultRow() {
        ...
        GlobalDataStructure.OneDisplayRow rowName = new GlobalDataStructure.OneDisplayRow();
        rowName.rowName = str_note;
        rowName.text = GlobalDataStructure.emptyString;
        rowName.image = null;
        rowName.rowType = GlobalDataStructure.ROW_USER_NAME;
        list.add(rowName);
    ...
    private void dispatchTakePictureIntent(int position) {
        ...
        takePictureIntent.putExtra(ADD_IDS_EXTRA_MESSAGE_POSITION, position);
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (mData.get(position).imageFile != null) {
                ...
                startActivityForResult(takePictureIntent, ADD_IDS_REQUEST_IMAGE_CAPTURE);
            }
        }
    }
    ...
    private File createImageFile(int position) throws IOException {
        ...
        String imageFileName = "AddIDs_" + position + "_";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if ((requestCode == ADD_IDS_REQUEST_IMAGE_CAPTURE) && (resultCode == RESULT_OK)) {
            int position = takePictureIntent.getIntExtra(ADD_IDS_EXTRA_MESSAGE_POSITION, 0);
