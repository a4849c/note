...
public class IDsSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ids_search);

        searchResults = new ArrayList<SearchMatch>();
        mIDsPageData = IDsPageData.getInstance();
        searchString = (SearchView) findViewById(R.id.search_ids_searchString);
        ...
        listView = (ListView) findViewById(R.id.search_ids_listview);
    ...
    private void search (String searchStr) {
        ...
        int pagePosition = 0;
        Iterator <GlobalDataStructure.OnePage> iteratorPage = mIDsPageData.mPagelist.iterator();
            ...
            if (convertView == null) {
                ...
                holder.title.setOnClickListener(new MyOnClickListener(holder) {
                    ...
                    public void onClick(View v, ViewHolder holder) {
                        ...
                        IDsTabFragment.setSelectedPageNumber(searchResults.get(pos).pageListPosition);
                        IDsTabFragment.topTabIndicator.notifyDataSetChanged();
                        IDsTabFragment.topTabIndicator.setCurrentItem(searchResults.get(pos).pageListPosition);
                        finish();
                    }
                });
