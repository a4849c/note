...
public class NoteSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchString = (SearchView) findViewById(R.id.search_note_searchString);
    ...
    private void search (String searchStr) {
        ...
        int pagePosition = 0;
        Iterator <GlobalDataStructure.OnePage> iteratorPage = mNotePageData.mPagelist.iterator();
            ...
            if (convertView == null) {
                ...
                holder.title.setOnClickListener(new MyOnClickListener(holder) {
                    ...
                    public void onClick(View v, ViewHolder holder) {
                        ...
                        NoteTabFragment.setSelectedPageNumber(searchResults.get(pos).pageListPosition);
                        NoteTabFragment.topTabIndicator.notifyDataSetChanged();
                        NoteTabFragment.topTabIndicator.setCurrentItem(searchResults.get(pos).pageListPosition);
                        finish();
                    }
                });
