...
public class WebsiteAddActivity extends AppCompatActivity {
    private Intent startIntent;
    private static Intent takePictureIntent;
    private MyAdapter adapter;
    private RecordDBHelper mDbHelper;
    String str_username = "User Name";
    String str_password = "Password";
    private WebsitePageData mWebsitePageData;
    private List<GlobalDataStructure.OneDisplayRow> mData;
    static final int ADD_WEBSITE_REQUEST_IMAGE_CAPTURE = 1;
    static final int CHECK_PASSWORD_REQUEST = 2;
    public final static String ADD_WEBSITE_EXTRA_MESSAGE_POSITION = "WebsiteAddActivity.POSITION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.website_add);
        ListView listView = (ListView) findViewById(R.id.add_website_listview);

        // Get the message from the startIntent
        startIntent = getIntent();
        int tab = startIntent.getIntExtra(MainActivity.EXTRA_MESSAGE_MAIN, -1);
        if (tab == GlobalDataStructure.TAB_WEBSITE) {
            mData = addDefaultRow();
        }
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(WebsiteAddActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                final EditText title = (EditText) findViewById(R.id.add_website_title);
                final String titleStr = title.getText().toString();
                final int pageNumber = WebsitePageData.getMaxWebsitePageNumber() + 1;
                    ...
                    DBBackgroudTask task = new DBBackgroudTask() {
                        ...
                        protected Object doInBackground(Object[] params) {
                            ...
                            for (GlobalDataStructure.OneDisplayRow row : mData) {
                                ...
                                values.put(RecordContract.RecordEntry.COLUMN_NAME_CATEGORY,GlobalDataStructure.TAB_WEBSITE);
                        ...
                        protected void onPostExecute(Object o) {
                            ...
                            // Read out the last added page from database, keep mWebsitePageData.mPagelist consistent with database
                            ...
                            if(cursor.moveToFirst()) {
                                ...
                                mWebsitePageData.mPagelist.add(onePage);

                                WebsitePageData.increaseWebsiteTabNumber();
                                WebsitePageData.setMaxWebsitePageNumber(pageNumber);
                                ...
                                WebsiteTabFragment.topTabIndicator.setCurrentItem(WebsitePageData.getWebsiteTabNumber()-1);
                            }
                            dbRead.close();
                        }
                    };
    ...
    private List<GlobalDataStructure.OneDisplayRow> addDefaultRow() {
        ...
        GlobalDataStructure.OneDisplayRow rowUserName = new GlobalDataStructure.OneDisplayRow();
        rowUserName.rowName = str_username;
        rowUserName.text = GlobalDataStructure.emptyString;
        rowUserName.image = null;
        rowUserName.rowType = GlobalDataStructure.ROW_USER_NAME;
        list.add(rowUserName);

        GlobalDataStructure.OneDisplayRow rowPassword = new GlobalDataStructure.OneDisplayRow();
        rowPassword.rowName = str_password;
        rowPassword.text = GlobalDataStructure.emptyString;
        rowPassword.image = null;
        rowPassword.rowType = GlobalDataStructure.ROW_PASSWORD;
        list.add(rowPassword);

        GlobalDataStructure.OneDisplayRow rowWebsite = new GlobalDataStructure.OneDisplayRow();
        rowWebsite.rowName = "Website";
        rowWebsite.text = "https://www.";
        rowWebsite.image = null;
        rowWebsite.rowType = GlobalDataStructure.ROW_TEXT;
        list.add(rowWebsite);

        GlobalDataStructure.OneDisplayRow rowPhone = new GlobalDataStructure.OneDisplayRow();
        rowPhone.rowName = "Linked Phone";
        rowPhone.text = GlobalDataStructure.emptyString;
        rowPhone.image = null;
        rowPhone.rowType = GlobalDataStructure.ROW_PHONE;
        list.add(rowPhone);

        GlobalDataStructure.OneDisplayRow rowQuestion = new GlobalDataStructure.OneDisplayRow();
        rowQuestion.rowName = "Remind Question";
        rowQuestion.text = GlobalDataStructure.emptyString;
        rowQuestion.image = null;
        rowQuestion.rowType = GlobalDataStructure.ROW_TEXT;
        list.add(rowQuestion);

        GlobalDataStructure.OneDisplayRow rowAnswer = new GlobalDataStructure.OneDisplayRow();
        rowAnswer.rowName = "Remind Answer";
        rowAnswer.text = GlobalDataStructure.emptyString;
        rowAnswer.image = null;
        rowAnswer.rowType = GlobalDataStructure.ROW_TEXT;
        list.add(rowAnswer);
    ...
    private void dispatchTakePictureIntent(int position) {
        ...
        takePictureIntent.putExtra(ADD_WEBSITE_EXTRA_MESSAGE_POSITION, position);
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (mData.get(position).imageFile != null) {
                ...
                startActivityForResult(takePictureIntent, ADD_WEBSITE_REQUEST_IMAGE_CAPTURE);
            }
        }
    }
    ...
    private File createImageFile(int position) throws IOException {
        ...
        String imageFileName = "AddWebsite_" + position + "_";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if ((requestCode == ADD_WEBSITE_REQUEST_IMAGE_CAPTURE) && (resultCode == RESULT_OK)) {
            int position = takePictureIntent.getIntExtra(ADD_WEBSITE_EXTRA_MESSAGE_POSITION, 0);
